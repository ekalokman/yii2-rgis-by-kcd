...
Return of `ekalokman\AdminPgsql\components\MenuHelper::getAssignedMenu()` has default format like:
...
return format of `ekalokman\AdminPgsql\components\MenuHelper::getAssignedMenu()` by provide a callback to this methode.
...
Using Sparated Menu
-------------------
Second parameter of `ekalokman\AdminPgsql\components\MenuHelper::getAssignedMenu()` used to get menu on it's own hierarchy.
